...
<div id="container">
  ...
  <div id="sidebar1">
    ...
    <p><!-- TemplateBeginEditable name="главно меню" -->    Главно меню<!-- TemplateEndEditable --></p>
  <!-- end #sidebar1 --></div>
  <div id="sidebar2">
    <h3><!-- TemplateBeginEditable name="ekstri" -->Sidebar2 <!-- TemplateEndEditable --></h3>
  <!-- end #sidebar2 --></div>
  <div id="apDiv2">
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','133','height','105','title','4ove4eta','src','../media/4ove4eta','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../media/4ove4eta' ); //end AC code
  ...
  <div id="mainContent">
    <h1><!-- TemplateBeginEditable name="Osnoven tekst" -->main<!-- TemplateEndEditable --><!-- end #mainContent --></h1>
    <!-- TemplateBeginEditable name="Съдържание" -->
    <p>Съдържание</p>
