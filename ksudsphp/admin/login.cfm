...
SELECT *
FROM ksudsadmin
ORDER BY KSUDSADMINID ASC 
</cfquery>
<cfif IsDefined("FORM.email")>
  <cfset MM_redirectLoginSuccess="../index.cfm">
  <cfset MM_redirectLoginFailed="login.cfm">
  <cfquery  name="MM_rsUser" datasource="ksuds">
  SELECT EMAIL,ADMINPASSWORD,USERROLE FROM ksudsadmin WHERE EMAIL=<cfqueryparam value="#FORM.email#" cfsqltype="cf_sql_clob" maxlength="50"> AND ADMINPASSWORD=<cfqueryparam value="#FORM.adminpassword#" cfsqltype="cf_sql_clob" maxlength="8">
  </cfquery>
  <cfif MM_rsUser.RecordCount NEQ 0>
    <cftry>
    <cflock scope="Session" timeout="30" type="Exclusive">
      <cfset Session.MM_Username=FORM.email>
      <cfset Session.MM_UserAuthorization=MM_rsUser.USERROLE[1]>
    </cflock>
...
</cfif><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
...
<div id="container">
  <div id="header">
    ...
    <li><a href="../news.cfm">Новини</a></li>
      <li><a href="login.cfm">Влез</a></li>
    <li><a href="logaut.cfm">Излез</a></li>
  </div>
  <div id="sidebar1">
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','133','height','105','title','4ove4eta','src','../media/4ove4eta','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../media/4ove4eta' ); //end AC code
  ...
  <div id="mainContent">
    <h1><!-- InstanceBeginEditable name="Osnoven tekst" --><form name="form1" method="POST" action="<cfoutput>#MM_loginAction#</cfoutput>">
      <table border="0">
        <tr>
          <td>Email Address</td>
          <td><label>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><label>
            <input type="submit" name="Вход" id="Вход" value="ВХОД">
          </label></td>
        </tr>
      </table>
    </form>
	<!-- InstanceEndEditable --><!-- end #mainContent --></h1>
